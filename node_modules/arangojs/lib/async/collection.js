...
class BaseCollection {
    ...
    _get(path, qs) {
        return this._connection.request({ path: `/_api/${this._urlPrefix}${path}`, qs }, res => res.body);
    }
    _put(path, body) {
...
class DocumentCollection extends BaseCollection {
    ...
    document(documentHandle) {
        return this._connection.request({ path: `/_api/${this._documentPath(documentHandle)}` }, res => res.body);
    }
    save(data, opts) {
        if (typeof opts === "boolean") {
            opts = { returnNew: opts };
